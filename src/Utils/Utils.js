...
function getCoverUrl(manga){
    ...
    const baseUrl = process.env.PROXY_URL ? `https://${process.env.PROXY_URL}` : 'http://localhost:5000';//if its local it will be set to whatever the local url is, if its deployed, it should be the domain of railway
